(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=new class{eventSource=null;TOPIC_URL=``;dataCallbacks=new Set;stateCallbacks=new Set;connect(){if(this.eventSource)return;let e=`smart-glasses-hud-dietrich-v2`,t=window.location.hash.match(/topic=([^&]+)/);t&&t[1]&&(e=t[1]),this.TOPIC_URL=`https://ntfy.sh/${e}/sse?since=10m`,console.log(`Connecting to Ntfy Server: ${this.TOPIC_URL}...`),this.eventSource=new EventSource(this.TOPIC_URL),this.eventSource.onopen=()=>{console.log(`Ntfy Connected successfully!`),this.notifyState(!0)},this.eventSource.onmessage=e=>{try{let t=JSON.parse(e.data);if(t.event===`message`){console.log(`[Ntfy] Received:`,t.message);let e=JSON.parse(t.message);this.notifyData(e)}}catch(e){console.error(`Failed to parse Ntfy message:`,e)}},this.eventSource.onerror=e=>{console.error(`Ntfy Error:`,e)}}disconnect(){this.eventSource&&(this.eventSource.close(),this.eventSource=null,this.notifyState(!1))}onData(e){this.dataCallbacks.add(e)}onStateChange(e){this.stateCallbacks.add(e)}notifyData(e){this.dataCallbacks.forEach(t=>t(e))}notifyState(e){this.stateCallbacks.forEach(t=>t(e))}};document.querySelector(`#app`).innerHTML=`
